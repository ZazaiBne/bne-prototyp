...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 min-h-screen bg-bneGreen/60 backdrop-blur-md text-white p-6 fixed left-0 top-0 shadow-xl border-r border-white/10">
