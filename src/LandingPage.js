...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      {/* Inhalt: Text + Bild nebeneinander */}
      <main className="max-w-6xl mx-auto px-6 py-16">
        <div className="flex flex-col md:flex-row items-center gap-12">
          {/* Text links */}
          <div className="flex-1 text-gray-800 text-justify">
            <h1 className="text-3xl md:text-4xl font-semibold text-blue-900 mb-6 text-left md:text-left">
              Willkommen beim BNE-Prototyp
            </h1>
            <p className="mb-4 leading-relaxed">
              Willkommen auf unserem BNE-Portal für pädagogische Fachkräfte – schön, dass Sie da sind!  
              Diese Website wurde im Rahmen eines Hochschulprojekts in Zusammenarbeit mit dem Landratsamt München entwickelt.
            </p>
            <p className="mb-4 leading-relaxed">
              Unser Ziel: Bildung für nachhaltige Entwicklung (BNE) in non-formalen Einrichtungen sichtbar machen, stärken und gemeinsam weiterentwickeln.
            </p>
            <p className="mb-4 leading-relaxed">
              🔍 <strong>Fragebogen:</strong> Um herauszufinden, wie BNE bereits in Ihrer Einrichtung gelebt wird  
              <br />
              📚 <strong>Selbstlerneinheiten:</strong> Kurze, praxisnahe Online-Impulse zu Themen aus dem sozialen, ökologischen und ökonomischen Bereich
            </p>
